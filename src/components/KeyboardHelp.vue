...
<template>
  <div
    v-if="open"
    class="fixed inset-0 z-50 bg-black/70 flex items-start justify-center overflow-y-auto p-4 md:items-center"
    role="dialog"
    aria-modal="true"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-sm">
          <div class="border border-tui-active/30 p-3">
            ...
            <div class="flex justify-between">
              <span>Alt (hold)</span><span>Show menu underlines</span>
            </div>
            <div class="flex justify-between">
              <span>Alt+S / A / H</span><span>Open System / Actions / Help</span>
            </div>
            <div class="flex justify-between">
              <span>Alt+[underlined]</span><span>Activate menu entry</span>
            </div>
            ...
            <div class="flex justify-between">
              <span>/</span><span>Focus search (Search page)</span>
            </div>
            <div class="flex justify-between">
              <span>PgUp/PgDn</span><span>Prev/Next (or load more)</span>
            </div>
            <div class="flex justify-between">
              <span>Ctrl+o / Ctrl+i</span><span>Back / Forward</span>
            </div>
            <div class="flex justify-between">
              <span>Ctrl+e / Ctrl+y</span><span>Scroll one row</span>
            </div>
            <div class="flex justify-between">
              <span>Ctrl+d / Ctrl+u</span><span>Scroll half page</span>
            </div>
            <div class="flex justify-between">
              <span>Ctrl+f / Ctrl+b</span><span>Scroll full page</span>
            </div>
          </div>
          ...
          <div class="border border-tui-active/30 p-3">
            ...
            <div class="flex justify-between">
              <span>[count]j / [count]k</span><span>Move selection</span>
            </div>
            ...
            <div class="flex justify-between">
              <span>zt / zz / zb</span><span>Scroll active row</span>
            </div>

            <div class="font-bold uppercase text-tui-cyan mt-4 mb-2">Item Page</div>
            <div class="flex justify-between">
              <span>[count]j / [count]k</span><span>Next/Prev comment</span>
            </div>
            <div class="flex justify-between">
            ...
            <div class="flex justify-between">
              <span>l</span><span>Expand + load + go to first child</span>
            </div>
            <div class="flex justify-between">
              <span>L</span><span>Expand + load recursively + go to first child</span>
            </div>
            <div class="flex justify-between"><span>o</span><span>Open story link</span></div>
            <div class="flex justify-between">
              <span>O</span><span>Open story link (new tab)</span>
            </div>
            <div class="flex justify-between"><span>v</span><span>Vote selected item</span></div>
            <div class="flex justify-between">
              <span>zt / zz / zb</span><span>Scroll active comment</span>
            </div>
          </div>
          ...
          <div class="border border-tui-active/30 p-3 md:col-span-2">
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-1">
              <div
                v-for="a in menuState.actions"
                :key="a.label"
                class="flex justify-between gap-4"
                :class="a.disabled ? 'opacity-30' : ''"
              >
