...
const feedRoutes: RouteRecordRaw[] = [
  {
    ...
    name: 'top',
    component: FeedPage,
    props: { feed: 'top' satisfies FeedKind },
    meta: { title: 'Top' },
  },
  {
    path: '/new',
    name: 'new',
    component: FeedPage,
    props: { feed: 'new' satisfies FeedKind },
    meta: { title: 'New' },
  },
  {
    path: '/best',
    name: 'best',
    component: FeedPage,
    props: { feed: 'best' satisfies FeedKind },
    meta: { title: 'Best' },
  },
  {
    path: '/ask',
    name: 'ask',
    component: FeedPage,
    props: { feed: 'ask' satisfies FeedKind },
    meta: { title: 'Ask' },
  },
  {
    path: '/show',
    name: 'show',
    component: FeedPage,
    props: { feed: 'show' satisfies FeedKind },
    meta: { title: 'Show' },
  },
  {
    path: '/jobs',
    name: 'jobs',
    component: FeedPage,
    props: { feed: 'jobs' satisfies FeedKind },
    meta: { title: 'Jobs' },
  },
]
...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/login', name: 'login', component: LoginPage, meta: { title: 'Login' } },
  {
    ...
    meta: { title: 'Auth terms' },
  },
  {
    path: '/me/submissions',
    name: 'me-submissions',
    component: AuthListPage,
    props: { kind: 'submissions' },
  ...
  {
    path: '/me/upvoted/submissions',
    name: 'me-upvoted-submissions',
    component: AuthListPage,
    props: { kind: 'upvoted-submissions' },
    meta: { title: 'Upvoted stories' },
  },
  {
    path: '/me/upvoted/comments',
    name: 'me-upvoted-comments',
    component: AuthListPage,
    props: { kind: 'upvoted-comments' },
    meta: { title: 'Upvoted comments' },
  },
  {
    path: '/me/favorites/submissions',
    name: 'me-favorites-submissions',
    component: AuthListPage,
    props: { kind: 'favorites-submissions' },
    meta: { title: 'Favorite stories' },
  },
  {
    path: '/me/favorites/comments',
    name: 'me-favorites-comments',
    component: AuthListPage,
    props: { kind: 'favorites-comments' },
    meta: { title: 'Favorite comments' },
  },
